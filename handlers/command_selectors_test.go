...
func TestRegExpCommandSelector(t *testing.T) {
	...
	if !selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test_"}}) {
		t.Error("/test_ command selector failed")
	}
	if selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/fest"}}) {
		t.Error("/fest command selector failed")
	}
	if selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test1e"}}) {
		t.Error("/test1e command selector failed")
	}
	if !selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test33_"}}) {
...
func TestCallbackCommandSelector(t *testing.T) {
	...
	if !selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/test_"}}) {
		t.Error("/test_ callback selector failed")
	}
	if selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/fest"}}) {
		t.Error("/fest callback selector failed")
	}
	if selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/test1e"}}) {
		t.Error("/test1e callback selector failed")
	}
	if !selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/test33_"}}) {
...
func TestCommandOrCallbackRegExpSelector(t *testing.T) {
	...
	if !selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/callback_"}}) {
		t.Error("/callback_ callback selector failed")
	}
	if selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/fest"}}) {
		t.Error("/fest command selector failed")
	}
	if selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/callback1e"}}) {
		t.Error("/callback1e callback selector failed")
	}
	if !selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test33_"}}) {
		t.Error("/test33_ command selector failed")
	}
	if !selector(&tgbotapi.Update{CallbackQuery: &tgbotapi.CallbackQuery{Data: "/callback33_"}}) {
...
func TestImageSelector(t *testing.T) {
	...
	if !selector(&tgbotapi.Update{Message: &tgbotapi.Message{Photo: []tgbotapi.PhotoSize{}}}) {
...
func TestAndSelector(t *testing.T) {
	...
	if !selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test_", Photo: []tgbotapi.PhotoSize{}}}) {
		t.Error("/test_ command selector failed")
	}
	if selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/fest", Photo: []tgbotapi.PhotoSize{}}}) {
		t.Error("/fest command selector failed")
	}
	if selector(&tgbotapi.Update{Message: &tgbotapi.Message{Text: "/test1_"}}) {
